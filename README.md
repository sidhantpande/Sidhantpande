...
<!-- PROFILE VIEWS -->
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=Sidhant185&color=2563EB&style=flat-square&label=Profile+Views" alt="Profile Views" />
</p>
...
## 👨‍💻 Vision & Engineering Metrics

I am a Full-Stack Software Engineer focused on designing scalable architectures, intelligent AI integrations, and high-performance modern web applications. **I don't just write code; I ship products.**

<div align="center">
  <table>
    <tr>
        <td align="center"><b>Live Users Impacted</b><br/><code>1,000+ Students & Hackers</code></td>
        <td align="center"><b>Leadership</b><br/><code>President, Open Source Club</code></td>
        <td align="center"><b>Production Deployments</b><br/><code>7+ Live Platforms</code></td>
        <td align="center"><b>Hackathons</b><br/><code>1st Runner-Up (24-Hour Build)</code></td>
    </tr>
  </table>
</div>
...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=nodejs,python,java,django,express,mongodb,postgres" />
  </a>
</p>
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=firebase,docker,aws,git,githubactions,linux" />
  </a>
</p>
...
## ⚙️ Showcase: Engineering at Scale

### 🏆 Featured: Study Buddy (Live Product & Hackathon Winner)
An AI-native educational tool for peer-to-peer learning. Built from zero to production in 24 hours. Features a native Monaco editor (VS Code in the browser), sandboxed Piston API code execution, and dynamic LLM (Gemini 2.0) code evaluation.
...
### 🌐 Scalable Event Platforms & Dashboards
Engineered the end-to-end ecosystems for *Code Nexus* (handling 400 attendees in 30 hours) and the *VST OpenSource Club* (managing 500+ student registrations). 
- **Core Architectures:** Virtual scrolling, request deduplication, distributed state management, CI/CD pipelines.
...
<details>
<summary><b>🤖 View AI & Agent Engineering (NOVA, JARVIS, Algorithmic Schedulers)</b></summary>
<br/>
Deep integrations parsing natural language tasks through modular NLP pipelines for asynchronous intelligent execution.

🔗 [NOVA](https://github.com/Sidhant185/Nova) | 🔗 [JARVIS](https://github.com/Sidhant185/jarvis) | 🔗 [Constraint-Satisfaction Schedulers](https://github.com/Sidhant185)
</details>

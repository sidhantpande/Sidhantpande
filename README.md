<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=220&section=header&text=Sidhant%20Pande&fontSize=90&animation=fadeIn&fontAlignY=38&desc=Full-Stack%20Web%20Developer%20%7C%20AI%20Enthusiast%20%7C%20Open%20Source%20Lead&descAlignY=62&descFontSize=22" />
</p>
...
## 🏗️ Professional Experience & Achievements

### 💼 Web Development & Tech Leadership

| Role | Highlight |
|------|-----------|
| **Freelance Web Developer** — Sattvahar Foods | Designed, developed & maintain the official e-commerce/business website ([sattvahar.in](https://sattvahar.in)) |
| **Tech Lead** — Noesis Tech-Fest | Directed all technical operations; spearheaded end-to-end development of digital platforms for the fest |
| **Event Manager & Lead Developer** — Code-Nexus | Gathered **400 attendees in 30 hours** (60% conversion rate); built the complete frontend website + admin dashboard |
| **Hackathon** — Vedam School of Technology | **1st Runner Up** in a 24-hour hackathon |
| **President** — Open Source Club | Lead student initiatives, foster open-source contributions, and manage technical teams for university-wide deployments |
